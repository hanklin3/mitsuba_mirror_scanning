...
exp_name = 'mirror_test'
# exp_name = 'diffuse_only_test'
save_dir = '/u/sidsoma/mirror_scanning_iccp24/experiments'
# scene_name = '/u/sidsoma/mirror_scanning_iccp24/scenes/planar_scene.xml'
...
savemat(f'/mitsuba/{exp_name}/params.mat', camera_params)
